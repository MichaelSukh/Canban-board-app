...
class ColumnService:
    ...
    def create_column(self, board_id: int, user_id: int, column: ColumnCreate) -> ColumnResponse:
        ...
        try:
            new_column = self.column_repository.create_column(board_id, column.model_dump())
    ...
    def update_column(self, column_id: int, user_id: int, column_update: ColumnUpdate) -> ColumnResponse:
        ...
        try:
            updated_column = self.column_repository.update_column(column_id, column_update.model_dump(exclude_unset=True))
